  ...
  return (
    <div>
      <div className="mb-8 text-center">
        ...
        <h1 className="mt-4 font-display text-3xl font-semibold text-ink dark:text-paper">Bem-vindo de volta</h1>
        <p className="mt-2 text-ink-soft dark:text-stone">Acesse sua conta para ver suas finanças.</p>
      </div>

      <form className="space-y-6" onSubmit={handleSubmit}>
        <div className="rounded-2xl border border-rule bg-paper-dark/30 p-4 dark:border-rule-dark dark:bg-night">
        <label className="mb-2 block text-sm font-medium text-ink-soft dark:text-stone" htmlFor="userName">Usuário</label>
        <div className="flex items-center gap-3 rounded-2xl border border-rule bg-white px-4 py-3 dark:border-rule-dark dark:bg-panel">
          <Mail className="h-5 w-5 text-ink-soft/60 dark:text-stone/60" />
          <input
            id="userName"
            type="text"
            value={userName}
        ...
        <div className="rounded-2xl border border-rule bg-paper-dark/30 p-4 dark:border-rule-dark dark:bg-night">
          <label className="mb-2 block text-sm font-medium text-ink-soft dark:text-stone" htmlFor="password">Senha</label>
          <div className="flex items-center gap-3 rounded-2xl border border-rule bg-white px-4 py-3 dark:border-rule-dark dark:bg-panel">
      ...
      <p className="mt-6 text-center text-sm text-ink-soft dark:text-stone">
        Ainda não tem conta?{' '}
        <Link to="/register" className="font-semibold text-ink underline decoration-rule decoration-2 underline-offset-4 dark:text-paper dark:decoration-rule-dark">
          Criar nova conta
        </Link>
      </p>
    </div>
